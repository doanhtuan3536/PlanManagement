...
function SprintModal({sprintModalOpen, closeSprintModal, sprintForm ,setSprintForm, createSprint, projectData }) {
    ...
    //           </div>
    //         </div>;
    return <Modal conditionOpen = {sprintModalOpen} onClickModalOverlay={closeSprintModal} header={
      <>
        <h2><FontAwesomeIcon icon={faPlus} /> Tạo Sprint mới</h2>
        <button className={cx('action-btn', 'btn-secondary')} onClick={closeSprintModal}>
          <FontAwesomeIcon icon={faTimes} />
